...
// warning in next prompt inserted; otherwise error message is shown, and todo list is not shown
		'set_protection' => "Password protection: NB: make sure myTDX/tmp directory exists!",
		'set_enabled' => "Enabled",
